    ...
    <div class="card mb-6 p-5">
        <form method="GET" action="{{ route('suppliers.index') }}">
            <div class="relative">
                ...
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Search supplier, first name, last name, or contact info..." class="form-input pl-11">
            </div>
        </form>
    </div>
    ...
    <div class="card table-wrap">
        <table class="data-table">
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center gap-2">
                                <a href="{{ route('suppliers.show', $supplier) }}" class="btn-secondary !min-h-0 !px-4 !py-2">
                ...
                @empty
                    <tr>
                        <td colspan="8" class="py-16 text-center text-slate-400">No suppliers found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
